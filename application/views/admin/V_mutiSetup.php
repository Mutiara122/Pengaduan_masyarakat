                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?= base_url('C_mutiAuth/setup') ?>">
                                ...
                                <button href="<?= base_url('C_mutiAuth') ?>" type="submit" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </button>
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?= base_url('C_mutiAuth') ?>">Already have an account? Login!</a>
                                </div>
                        </div>
                    </div>
                </div>
